        ...
        <el-row>
          <el-col :span="24" :class="{area_content:true,hidden:isShowArea}">
            ...
            <span v-for="(item,index) in strategy" :key="index" :id="item.id">
              <nuxt-link
                :to="`/hotel?city=${item.city}&scenic=${item.id}`"
                class="strategy_id"
              >{{item.name}}</nuxt-link>
            </span>
          </el-col>
          <nuxt-link to="#">
            <i
              ...
              @click="show_content"
              :class="{icon_hide:!isShowArea,icon_show:isShowArea}"
            ></i>
            等{{strategy.length}}个区域
          </nuxt-link>
        </el-row>
      </el-col>
    </el-row>
          ...
          <el-col :span="24">
            ...
            >
              <span class="HotelLever">
                <i class="iconfont icon-huangguan2" style="color:#f90"></i>
                <i class="iconfont icon-huangguan2" style="color:#f90"></i>
                <i class="iconfont icon-huangguan2" style="color:#f90"></i>
